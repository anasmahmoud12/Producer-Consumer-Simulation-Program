...
@Component({
    ...
    <div class="canvas-wrapper" 
      ...
      <svg class="canvas-svg">
        ...
        <g *ngFor="let queue of queues; trackBy: trackById"
           ...
           [class.frame-flash]="isFrameUpdate">
  ...
  styles: [`
    ...
    /* Frame Flash Animation for Replay */
    .frame-flash {
      animation: frameFlash 0.3s ease-out;
    }
...
export class CanvasComponent implements OnChanges {
  ...
  @Input() replayFrameCount: number = 0;
  ...
  isFrameUpdate = false;
  private frameUpdateTimeout?: any;

  constructor(private cdr: ChangeDetectorRef) {}

  ngOnChanges(changes: SimpleChanges) {
    if (changes['replayFrameCount'] && !changes['replayFrameCount'].firstChange) {
      console.log('🎨 Canvas detected frame change:', this.replayFrameCount);
      
      // Trigger flash animation
      this.isFrameUpdate = true;
